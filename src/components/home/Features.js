      ...
      <div className="max-w-6xl mx-auto grid md:grid-cols-3 gap-10">
        {features.map((f, i) => (
          <Link key={i} href={`/features/${f.slug}`}>
            <div className="group bg-white p-10 rounded-3xl border border-slate-100 hover:border-hover hover:shadow-2xl hover:shadow-primary/5 transition-all duration-300">
